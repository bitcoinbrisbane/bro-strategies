...
export function testWithdraw() {
  it.skip("should succeed when a single user withdraws InvestmentToken that he/she has - fully withdraw", async function () {
  ...
  it.skip("should succeed when a single user withdraws InvestmentToken that he/she has - partially withdraw", async function () {
    await this.investHelper
      .deposit(this.investable, this.user0, {
  ...
  it.skip("should succeed when a single user withdraws InvestmentToken that he/she has - partially withdraw and let someone else receive USDC", async function () {
    await this.investHelper
      .deposit(this.investable, this.user0, {
  ...
  it.skip("should succeed when a single user withdraws InvestmentToken that he/she has - let someone else receive InvestmentToken and fully withdraw", async function () {
    await this.investHelper
      .deposit(this.investable, this.user0, {
        amount: ethers.utils.parseUnits("10", this.depositTokenDecimals),
        minimumDepositTokenAmountOut: BigNumber.from(0),
  ...
  it.skip("should fail when a single user withdraws zero amount", async function () {
    await this.investHelper
      .deposit(this.investable, this.user0, {
        amount: ethers.utils.parseUnits("3", this.depositTokenDecimals),
        minimumDepositTokenAmountOut: BigNumber.from(0),
  ...
  it.skip("should fail when a single user withdraws that he/she doesn't have", async function () {
    await this.investHelper
      .deposit(this.investable, this.user0, {
        amount: ethers.utils.parseUnits("3", this.depositTokenDecimals),
        minimumDepositTokenAmountOut: BigNumber.from(0),
  ...
  it.skip("should succeed when multiple users withdraw InvestmentTokens that they have - delayed fully withdraw", async function () {
  ...
  it.skip("should succeed when multiple users withdraw InvestmentTokens that they have - delayed partially withdraw", async function () {
    // The first user deposits.
    await this.investHelper
      .deposit(this.investable, this.user0, {
        amount: ethers.utils.parseUnits("3", this.depositTokenDecimals),
  ...
  it.skip("should succeed when multiple users withdraw InvestmentTokens that they have - immediate full withdrawal", async function () {
    // The first user deposits.
    await this.investHelper
      .deposit(this.investable, this.user0, {
        amount: ethers.utils.parseUnits("3", this.depositTokenDecimals),
  ...
  it.skip("should fail when multiple users withdraw zero amount", async function () {
    // The first user deposits.
    await this.investHelper
      .deposit(this.investable, this.user0, {
        amount: ethers.utils.parseUnits("10", this.depositTokenDecimals),
  ...
  it.skip("should fail when multiple users withdraw that they don't have", async function () {
    // The first user deposits.
    await this.investHelper
      .deposit(this.investable, this.user0, {
        amount: ethers.utils.parseUnits("10", this.depositTokenDecimals),

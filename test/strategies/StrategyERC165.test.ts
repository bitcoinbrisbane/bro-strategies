...
export function testStrategyERC165() {
  describe("ERC165", async function () {
    it.skip("should succeed to support all interfaces that strategy implements", async function () {
    ...
    it.skip("should fail to support any interface that strategy doesn't implement", async function () {
      expect(await this.strategy.supportsInterface("0x2ac9cdaa")).to.equal(false) // IPortfolio
